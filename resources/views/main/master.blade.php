...
<body>
 ...
 {{  site_settings("About Us")  }} 
                                ...
                                <ul class="list-unstyled list-inline socials">
                                    <li>
                                        <a href="https://{{  site_settings('facebook')  }} ">
                                            <i class="fa fa-facebook fa-fw"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://{{  site_settings('instagram')  }} " target="_blank">
                                            <i class="fa fa-instagram fa-fw"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://{{  site_settings('twitter')  }} " target="_blank">
                                            <i class="fa fa-twitter fa-fw"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://{{  site_settings('youtube')  }}  " target="_blank">
